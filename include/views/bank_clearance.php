<div class="row gutters">
    <div class="col-12">
        <div class="col-12 text-right">
            <button class="btn btn-primary add_bc_btn" style="display:none;"><span class="icon-add"></span>Add Bank Clearance</button>
                                    ...
                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div style="display: flex;">
                                                <input type='date' id='transaction_date' name='transaction_date' class="form-control" tabindex='3'>
