<div class="row gutters">
        ...
        <div class="card profit">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <div class="row">
                            <table id="profit_table" class="table custom-table">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th><b>Credit</b></th>
    ...
    <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card benefit_check">
            <div class="card-header">
                <h5 class="card-title">Benefit Check</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <div class="row">
                            <table  id="benefit_check_table" class="table custom-table">
								<thead >
									<th></th>
									<th>Credit</th>
									<th>Debit</th>
