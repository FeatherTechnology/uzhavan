...
function getOpeningBal(type, from_date, to_date, month) {
    ...
    $.post('api/accounts_files/balance_sheet_files/bs_opening_bal.php', args, function (response) {
        if (response.length > 0) {
            $('#balance_sheet_table tbody tr:first td:nth-child(2)').text(moneyFormatIndia(response[0]['hand_cash']));
        }
    }, 'json');
} 
...
function getBalSheetDetails(type, from_date, to_date, month) {
    ...
    $.post('api/accounts_files/balance_sheet_files/hand_cash_balance_sheet.php', args, function (response) {
        ...
        $('#balance_sheet_table tbody tr:nth-child(13) td:nth-child(3)').text(moneyFormatIndia(response[0]['advdr']));
        $('#balance_sheet_table tbody tr:nth-child(14) td:nth-child(3)').text(moneyFormatIndia(response[0]['expdr']));
...
function getBalSheetTotal() {
    ...
    $('#balance_sheet_table tbody tr:nth-child(15) td:nth-child(3)').text(moneyFormatIndia(close));
