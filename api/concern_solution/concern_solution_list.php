...
foreach ($result as $row) {
    ...
    if ($row['con_status'] == 0) {
        if ($row['designation'] == "Director" || $row['designation'] == "Manager" || $row['designation'] == "Admin" || $row['designation'] == "TL" || $row['designation'] == "Training TL" || $row['designation'] == "Executive Director" ) {
